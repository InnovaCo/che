...
(function() {
  ...
  define('dom',["utils/guid", "lib/domReady", "underscore"], function(guid, domReady, _) {
...
(function() {
  ...
  define('utils/destroyer',["underscore"], function(_) {
    var destroyer;
...
(function() {
  ...
  define('widgets',["events", "dom", "utils/destroyer", "config", "utils/guid", "underscore"], function(events, dom, destroyer, config, guid, _) {
...
(function() {
  ...
  define('loader',['widgets', 'config', 'utils/widgetsData', 'underscore', 'dom!'], function(widgets, config, widgetsData, _) {
    var loader;
    loader = {
...
(function() {
  ...
  define('utils/params',["underscore"], function(_) {
    var params;
...
(function() {
  ...
  define('clicks',['dom!', 'config', 'events', 'utils/params'], function(dom, config, events, params) {
...
(function() {
  ...
  define('ajax',['events', 'utils/params', "utils/destroyer", "underscore"], function(events, params, destroyer, _) {
...
(function() {
  ...
  define('sectionsHistory',['events', 'history', 'widgets', 'loader', 'dom', 'ajax', 'utils/storage', 'utils/destroyer', 'utils/widgetsData', 'underscore'], function(events, history, widgets, loader, dom, ajax, storage, destroyer, widgetsData, _) {
    /* 
    data:
      <selector>: <plainHTML>
    */
...
(function() {
  ...
  requirejs(['loader', 'clicks', 'sectionsHistory'], function(loader) {});
