...
(function() {
  ...
  define('dom',["utils/guid", "lib/domReady"], function(guid, domReady) {
...
(function() {
  ...
  define('loader',['widgets', 'config', 'utils/widgetsData', 'dom!'], function(widgets, config, widgetsData) {
    var loader;
    loader = {
...
(function() {
  ...
  define('sectionsHistory',['events', 'history', 'widgets', 'loader', 'dom', 'ajax', 'utils/storage', 'utils/destroyer', 'utils/widgetsData'], function(events, history, widgets, loader, dom, ajax, storage, destroyer, widgetsData) {
    /* 
    data:
      <selector>: <plainHTML>
    */
